...
import 'package:semoton_front/a_l/chat_yellow/chat_box4.dart';
...
class _ChatBox3State extends State<ChatBox3> with SingleTickerProviderStateMixin {
  late Ticker _ticker;
  int _currentIndex = 0;
  final String _text = '이거 작년에 선배가 찍은 사진인데,';
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    right: 10,
                    bottom: 40,
                    child: Image.asset('assets/mission_picture.jpg', width: 270, height: 120,),)
