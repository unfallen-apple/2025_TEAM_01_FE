...
import 'package:semoton_front/a_l/chat_brown/chat_box3.dart';

class ChatBox2 extends StatefulWidget {
  final String missionTitle; // 1. 필드 선언
...
class _ChatBox2State extends State<ChatBox2> with SingleTickerProviderStateMixin {
  late Ticker _ticker;
  int _currentIndex = 0;
  final String _text = '어쩌구저쩌구 스크립트 적는곳이다.';
        ...
        body: Stack(
          children: [
            ...
            Positioned(
              ...
              right: 20,
              top: 120,
              child: Image.asset('assets/character1/introduce.png', width: 150, height: 370),
            ),
            Positioned(
              left: 20,
              right: 20,
