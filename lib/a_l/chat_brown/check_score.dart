...
import 'package:semoton_front/a_l/chat_brown/chat_box8.dart' as brown;
            ...
            Positioned(
              ...
              child: ElevatedButton(
                onPressed: (){Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => brown.ChatBox8()),
                );},
...
class _ScoreState extends State<Score> with SingleTickerProviderStateMixin {
  ...
  late Animation<double> _animation; // 숫자 증가

  @override
  void initState() {
    super.initState(); //애니메이션 초기화
    _controller = AnimationController(
      duration: Duration(seconds: 100), // 높을 수록 느려짐
      vsync: this, //애니메이션 필요할때만 작동 - 리소스 낭비 막기
    );
    _animation = Tween<double>(begin: 0.0, end: 4.0) // end에 사용자 학점 변수 대입
