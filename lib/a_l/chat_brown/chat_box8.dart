//점수와 함께 대화하는 화면 8페이지
import 'package:semoton_front/a_l/chat_brown/chat_last_page.dart';
import 'package:flutter/material.dart';
import 'package:semoton_front/a_l/chat_brown/check_score.dart';
import 'package:flutter/scheduler.dart';


class ChatBox8 extends StatefulWidget {
  const ChatBox8({super.key});
  @override
...
class _ChatBox8State extends State<ChatBox8> with SingleTickerProviderStateMixin {
  late Ticker _ticker;
  int _currentIndex = 0;
  final String _text = '점수가 어떤지 수고했다는 등의 내용을 담는다';
                ...
                children: [
                  ...
                  Positioned( //우측 화살표
                      ...
                      child: IconButton(onPressed: (){
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => ChatLastPage()),
                        );
                      },
